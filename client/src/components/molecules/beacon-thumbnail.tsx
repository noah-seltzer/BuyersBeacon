...
const UserInfoWithRating: FC<{ userId: string; isWrappedInLink?: boolean }> = ({ 

  userId, 

  isWrappedInLink = false 
  ...
  // If already wrapped in a link (like in BeaconThumbnail), just return the content
  ...
  // Otherwise, wrap it in a Link component
          ...
          <div className="space-y-3">
            ...
            {beacon.userId && (
              ...
              <div className="pt-2 mt-2 border-t border-border/40">
                ...
                <UserInfoWithRating userId={beacon.userId} isWrappedInLink={true} />
