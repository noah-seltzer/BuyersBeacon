...
import { User, Review, UserRating, PaginatedReviewsResponse } from "@/types/user";
...
export const beaconApi = createApi({
  ...
  endpoints: (builder) => ({
    // Review endpoints
    getUserReviews: builder.query<PaginatedReviewsResponse, { userId: string; page?: number; pageSize?: number }>({
